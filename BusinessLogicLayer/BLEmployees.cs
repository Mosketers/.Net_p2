...
namespace BusinessLogicLayer
{
    public class BLEmployees : IBLEmployees
    {
       private IDALEmployees _dal;
        ...
        {
            Employee currentEmp =_dal.GetEmployee(idEmployee);
            if (currentEmp is PartTimeEmployee){
                return ((PartTimeEmployee)currentEmp).HourlyRate * hours;
            }
            else {
                throw new Exception("No es part time");
            }
        }
    }
}
